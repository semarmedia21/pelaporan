...
<body onload = "JavaScript:AutoRefresh(240000);" id="page-top">
                ...
                <div class="container-fluid">
                    ...
                    <?php $this->load->view("admin/_partials/crud_notif.php")?>
                     ...
                     <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                             <?php $this->load->view("admin/daftar_it/data1.php")?>
                        </div>
                    </div>
   ...
   <?php $this->load->view("admin/daftar_it/modal.php")?>
...
$("#cari2").on("keyup", function() {
    var value = $(this).val().toLowerCase();
    $("#tabelproses tr").filter(function() {
      $(this).toggle($(this).text().toLowerCase().indexOf(value) > -1)
    });
  });
});
