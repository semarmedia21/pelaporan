                          ...
                          <td>
                               ...
                               <?php } ?>
                                ...
                                <a data-placement="top" data-toggle="modal" data-target="#modal_show_det<?php echo $reqno; ?>" data-popup="tooltip" title="<?php echo $reqno; ?>"  class="btn btn-primary btn-circle ">
                                    <span class="font-weight-bold"> <?php echo $cnt; ?> </span>
                                  

                                    <a  href="<?php echo base_url().'index.php/admin/req?reqno='.$reqno.'&ku='.$ku?>"  class="fas fa-user-check btn-success btn-circle  ">
