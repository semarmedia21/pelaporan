...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
                    ...
                    <?php $this->load->view("admin/_partials/crud_notif.php")?>
                      ...
                      <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Rekap Pengunjung</h6>
                        </div>
            ...
            <div id="tampil_pengunjung" class=""></div>
...
<script>
   $(function(){
    $("#b_pengunjung").click(function(){
       ...
       $.ajax({
          url:"<?php echo base_url().'index.php/Admin/Sim/c_data_pengunjung'?>",
          type:"POST",
          data:"vtanggal="+vtanggal,
          cache:false,
          success:function(html){
          $("#tampil_pengunjung").html(html);
          }
       })
      })
   })
