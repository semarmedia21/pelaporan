    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <form method="post" action="<?php echo base_url().'index.php/Admin/Laporan/exportXls_hum'?>">
                ...
                <div id="tampil_laporan_hum" class="row"></div>
...
<script>
   $(function(){
    $("#tampil").click(function(){
       ...
       $.ajax({
          url:"<?php echo base_url().'index.php/Admin/Laporan/tampil_laporan_hum'?>",
          type:"POST",
          data:"vtanggal="+vtanggal,
          cache:false,
          success:function(html){
          $("#tampil_laporan_hum").html(html);
          $("#download").show();
          }
       })
...
$function()
   ...
   $.ajax({
    url: "<?php echo base_url().'index.php/Admin/Laporan/exportXls_hum'?>",
    type: "POST",
